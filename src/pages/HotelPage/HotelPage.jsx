    ...
    <>
      ...
      <Container className="hotel-page">
        ...
        <p className="hotel-page__text">
          ...
          aperiam at, deleniti deserunt ducimus eaque eos est exercitationem ipsum
          itaque maxime nam nobis non odio perspiciatis praesentium quas quia
          quidem sapiente sed sit veritatis voluptatum. Aperiam cupiditate
          ...
          dicta, distinctio et excepturi maxime, nam possimus saepe voluptatibus!
          Autem deserunt dolore, dolorem doloremque dolores esse excepturi,
          facilis, labore mollitia non possimus quas recusandae voluptas
          voluptate.
        </p>
        <p className="hotel-page__text">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab alias
