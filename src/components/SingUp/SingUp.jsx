    ...
    <Container>
      <div className={classes.root}>
        ...
        <div className={classes.wrapMobile}>
          <h3 className={classes.title}>
            Sign up in the app and
            get 20% off your first booking
          </h3>
          <Button variant='text' className={classes.buttonInstall}>Install</Button>
        </div>
        <Button className={classes.buttonClose} variant='icon' aria-label="close sing-up">
          <Close />
        </Button>
      </div>
    </Container>
